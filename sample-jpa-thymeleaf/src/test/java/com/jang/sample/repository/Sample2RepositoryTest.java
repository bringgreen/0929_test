...
@DataJpaTest
public class Sample2RepositoryTest {
    ...
    */
    ...
    public void sample_insert_test2() {
    	...
    	Sample2 sample2 = sample2Repository.save(new Sample2("insert test","Foundation Layer","Y","eGov"));
    	sample2 = sample2Repository.save(new Sample2("insert test","Foundation Layer","Y","eGov"));
    	sample2 = sample2Repository.save(new Sample2("insert test","Foundation Layer","Y","eGov"));
    	
    	
    	System.out.println("sample2>>>>"+sample2);
    	System.out.println("findSampleByName>>>>"+sample2Repository.findSampleByName("insert test"));
